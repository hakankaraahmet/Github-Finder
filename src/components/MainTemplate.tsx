    ...
    <div>
      ...
      <section className="relative 2xl bg-gray-800 min-h-screen">
        <div className="relative container px-4 mx-auto">
          ...
          {/* Content goes here */}
          {loading ? (
            <h1 className="text-green-300 text-3xl text-center">Loading please wait...</h1>
          ) : error ? (
            <h2 className="text-red-300 text-3xl text-center">{error?.data.message}</h2>
          ) : (
              ...
              <div className="flex flex-wrap -mx-4 mb-20">
                ...
                />
                  ...
                  <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-lg text-xs font-medium bg-green-500 text-green-800">
                    {profileList?.public_repos ? profileList?.public_repos : "N/A"}
                  </span>
                      </h4>
                      ...
                      <h4 className="mb-8 lg:mb-4  text-white font-bold">
                        Gists:{" "}
                  <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-lg text-xs font-medium bg-green-500 text-green-800">
                    {profileList?.public_gists ? profileList?.public_gists : "N/A"}
                  </span>
                      </h4>
                      <div className="mb-6 py-px bg-gray-500"></div>
                ...
                <div className="w-full lg:w-1/2 px-4">
                  ...
                  {reposList?.name !== 'Error' && reposList?.map((repo:any) => (
